                        ...
                        if (logsSettings[0].guildbanremove === "true") {
                            if (logsSettings[0].webhookID && logsSettings[0].webhookToken) {
                                ...
                                let embed = new MessageEmbed()
                                    ...
                                    .setDescription(lang.unbanned(user))
                                    .addField(lang.userInfos, `${user.username}#${user.discriminator} (${user.id}) ${user.bot ? '\nIs a bot' : ''}`, true)
                                    .addField(lang.reason, lang.none, true)
                                    .addField(lang.unbannedBy, lang.unknownUser, true)
                                    .setColor("RANDOM")
                                    .setTimestamp();
