    ...
    async run(message, args) {
        ...
        message.guild.members.fetch(user.id).then(member => {
            ...
            let embed = new MessageEmbed()
                ...
                .addField(message.guild.lang.COMMANDS.USERINFO.currentlyActiveOn, Object.keys(member.user.presence.clientStatus || {}).map(x => x.charAt(0).toUpperCase() + x.slice(1)).join(', ') || message.guild.lang.COMMANDS.USERINFO.offline)
