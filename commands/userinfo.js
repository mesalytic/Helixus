  ...
  if (!ment) {
    ...
    const nomentembed = new Discord.MessageEmbed ()
      ...
      .addField (
        ...
        `${moment (message.author.createdAt).format (bot.lang.infos.userinfo.createddate)}`,
        true
      )
      .addField (
        bot.lang.infos.userinfo.game,
        `${message.author.presence.activity ? message.author.presence.activity.name : bot.lang.infos.userinfo.none}`,
        true
      )
    ...
    const embed = new Discord.MessageEmbed ()
      ...
      .addField (
        bot.lang.infos.userinfo.game,
        `${ment.presence.activity ? ment.presence.activity.name : bot.lang.infos.userinfo.none}`,
        true
      )
      .addField (bot.lang.infos.userinfo.roles, rlist, true)
