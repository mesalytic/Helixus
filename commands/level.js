  ...
  con.query(
    ...
    (err, rows) => {
      ...
      const lvlEmbed = new Discord.MessageEmbed()
        ...
        .setDescription(bot.lang.levels.level.level.replace("${lvl}", lvl).replace("${xp}", xp).replace("${diffenrece}", clvl))
        .setFooter(bot.lang.levels.level.difference.replace("${difference}", difference));
